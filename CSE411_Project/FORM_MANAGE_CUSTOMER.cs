    ...
    public partial class FORM_MANAGE_CUSTOMER : Form
    {
        ...
        private void BTN_INSERT_CUSTOMER_Click(object sender, EventArgs e)
        {
           bool check= customer.insertCustomer(TB_FNAME.Text,TB_LNAME.Text, TB_TEL.Text,TB_EMAIL.Text);
            ...
            {
                MessageBox.Show("Fail To Insert", "New Customer", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void BTN_UPDATE_CUSTOMER_Click(object sender, EventArgs e)
        {
            ...
            {
                int a = Convert.ToInt32(TB_ID_CUSTOMER.Text);
                bool check=customer.updateCustomer(a, TB_FNAME.Text, TB_LNAME.Text, TB_TEL.Text, TB_EMAIL.Text);
                ...
                {
                    MessageBox.Show("Fail to update", "Update Customer", MessageBoxButtons.OK, MessageBoxIcon.Information);
